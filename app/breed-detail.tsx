    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.container}>
        <View style={styles.breedCard}>
          ...
          {showFullImage && getBreedImage(selectedBreed.image_filename, selectedBreed.breed) && (
            <Pressable style={styles.fullScreenModal} onPress={() => setShowFullImage(false)}>
              <View style={styles.fullScreenImageContainer}>
                <Image 
                  ...
                  resizeMode="contain"
                />
                <Text style={styles.fullScreenImageText}>{selectedBreed.breed}</Text>
              </View>
            </Pressable>
          )}
